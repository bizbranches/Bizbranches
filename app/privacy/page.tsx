  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-10 md:py-14 max-w-4xl">
        <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-2">Privacy Policy</h1>
        <p className="text-muted-foreground mb-8">Last updated: August 30, 2024</p>
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Interpretation and Definitions</h2>
        ...
        <p className="text-foreground/90 leading-relaxed mb-6">For the purposes of this Privacy Policy:</p>
        <ul className="list-disc pl-6 space-y-2 text-foreground/90 mb-8">
          ...
          <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to BizBranches.</li>
          ...
          <li><strong>Website</strong> refers to BizBranches, accessible from <a href="https://bizbranches.pk/" className="text-primary underline">https://bizbranches.pk/</a></li>
          <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>

        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Collecting and Using Your Personal Data</h2>
        ...
        <p className="text-foreground/90 leading-relaxed mb-4">Usage Data is collected automatically when using the Service.</p>
        <p className="text-foreground/90 leading-relaxed mb-4">
        ...
        <h3 className="text-xl font-semibold text-foreground mb-2">Tracking Technologies and Cookies</h3>
        <p className="text-foreground/90 leading-relaxed mb-4">
        ...
        <p className="text-foreground/90 leading-relaxed mb-2">We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul className="list-disc pl-6 space-y-2 text-foreground/90 mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Use of Your Personal Data</h2>
        <p className="text-foreground/90 leading-relaxed mb-4">The Company may use Personal Data for the following purposes:</p>
        <ul className="list-disc pl-6 space-y-2 text-foreground/90 mb-8">
        ...
        <p className="text-foreground/90 leading-relaxed mb-4">We may share Your personal information in the following situations:</p>
        <ul className="list-disc pl-6 space-y-2 text-foreground/90 mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Retention of Your Personal Data</h2>
        <p className="text-foreground/90 leading-relaxed mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Transfer of Your Personal Data</h2>
        <p className="text-foreground/90 leading-relaxed mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Delete Your Personal Data</h2>
        <p className="text-foreground/90 leading-relaxed mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Disclosure of Your Personal Data</h2>
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Security of Your Personal Data</h2>
        <p className="text-foreground/90 leading-relaxed mb-8">
          The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
        </p>

        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Children’s Privacy</h2>
        <p className="text-foreground/90 leading-relaxed mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Links to Other Websites</h2>
        <p className="text-foreground/90 leading-relaxed mb-8">
          Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party’s site. We strongly advise You to review the Privacy Policy of every site You visit. We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.
        </p>

        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Changes to this Privacy Policy</h2>
        <p className="text-foreground/90 leading-relaxed mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-3">Contact Us</h2>
        <p className="text-foreground/90 leading-relaxed mb-2">If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul className="list-disc pl-6 space-y-2 text-foreground/90">
          <li>By email: <a href="mailto:support@bizbranches.pk" className="text-primary underline">support@bizbranches.pk</a></li>
          <li>By visiting this page on our website: <a href="https://bizbranches.pk/" className="text-primary underline">https://bizbranches.pk/</a></li>
        </ul>
      </div>
    </main>
  )
