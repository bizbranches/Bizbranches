    ...
    <footer className="bg-[#253253] text-white">
      <div className="max-w-7xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* Departments */}
          <div>
            <h4 className="text-teal-300 text-lg font-semibold mb-4">Departments</h4>
          ...
          {/* Recent news */}
          <div>
            <h4 className="text-teal-300 text-lg font-semibold mb-4">Recent news</h4>
            <div className="space-y-4 text-sm">
              <div>
                <Link href="#" className="hover:underline text-slate-100">Cantt Classic Villas Multan</Link>
                <div className="text-slate-300/80 text-xs">April 23, 2025</div>
              </div>
              <div>
                <Link href="#" className="hover:underline text-slate-100">Al Raheem Villas Multan</Link>
                <div className="text-slate-300/80 text-xs">April 23, 2025</div>
              </div>
            </div>
          </div>
